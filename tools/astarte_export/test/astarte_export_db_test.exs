defmodule Astarte.Export.FetchDataDBTest do
  ...
  test "test to extract an interface information from interfaces tables for test realm"  do
   ...
   automaton: {%{
    ...
    %{
      1 => <<138, 232, 32, 4, 6, 189, 230, 9, 37, 174, 18, 246, 100, 208, 59,
        61>>,
      2 => <<239, 214, 216, 27, 149, 244, 197, 154, 249, 139, 4, 124, 203, 209,
        129, 104>>,
      3 => <<246, 193, 132, 180, 190, 183, 60, 188, 205, 97, 232, 109, 186, 77,
        12, 104>>,
      4 => <<172, 167, 229, 205, 125, 90, 98, 1, 108, 196, 77, 90, 237, 255,
        243, 181>>,
      5 => <<139, 126, 229, 60, 227, 249, 244, 249, 43, 11, 16, 50, 55, 119,
        228, 200>>
    }},
   interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196, 80,
     40, 44, 172>>,
   major_version: 0,
   minor_version: 1,
   ...
   type: :datastream
    ...
    {:ok, conn} = Queries.get_connection()
    assert {:ok, interface_details} == Queries.fetch_interface_descriptor(conn, @realm, @individual_datastream_interface, @major_version, []) 
    end 
   ...
   %Astarte.Core.Mapping{
     ...
     endpoint_id: <<246, 193, 132, 180, 190, 183, 60, 188, 205, 97, 232, 109,
       186, 77, 12, 104>>,
     expiry: 0,
     explicit_timestamp: false,
     interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196,
       80, 40, 44, 172>>,
     path: nil,
   ...
   %Astarte.Core.Mapping{
     ...
     endpoint_id: <<172, 167, 229, 205, 125, 90, 98, 1, 108, 196, 77, 90, 237,
       255, 243, 181>>,
     expiry: 0,
     explicit_timestamp: false,
     interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196,
   ...
   %Astarte.Core.Mapping{
     ...
     endpoint_id: <<239, 214, 216, 27, 149, 244, 197, 154, 249, 139, 4, 124,
       203, 209, 129, 104>>,
     expiry: 0,
     explicit_timestamp: false,
     interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196,
   ...
   %Astarte.Core.Mapping{
     ...
     endpoint_id: <<138, 232, 32, 4, 6, 189, 230, 9, 37, 174, 18, 246, 100, 208,
       59, 61>>,
     expiry: 0,
     explicit_timestamp: false,
     interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196,
   ...
   %Astarte.Core.Mapping{
     ...
     endpoint_id: <<139, 126, 229, 60, 227, 249, 244, 249, 43, 11, 16, 50, 55,
       119, 228, 200>>,
     expiry: 0,
     explicit_timestamp: false,
     interface_id: <<215, 150, 135, 110, 91, 114, 158, 159, 125, 93, 40, 196,
  ...
  {:ok, conn} = Queries.get_connection()
   assert {:ok, interface_mappings} == Queries.fetch_interface_mappings(conn, @realm, interface_id, [])
   end 

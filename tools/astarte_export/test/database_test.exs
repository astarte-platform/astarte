defmodule Astarte.DatabaseTestdata do
  ...
  @values [
    """
      INSERT INTO #{@realm_test}.individual_datastreams (device_id, interface_id, endpoint_id, path, value_timestamp, reception_timestamp, reception_timestamp_submillis, string_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_datastreams (device_id, interface_id, endpoint_id, path, value_timestamp, reception_timestamp, reception_timestamp_submillis, boolean_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_datastreams (device_id, interface_id, endpoint_id, path, value_timestamp, reception_timestamp, reception_timestamp_submillis, longinteger_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_datastreams (device_id, interface_id, endpoint_id, path, value_timestamp, reception_timestamp, reception_timestamp_submillis, double_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_datastreams (device_id, interface_id, endpoint_id, path, value_timestamp, reception_timestamp, reception_timestamp_submillis, integer_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.objectdatastreams_org_v0 (device_id, path, reception_timestamp, reception_timestamp_submillis, v_d, v_x, v_y) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_properties (device_id, interface_id, endpoint_id, path, reception_timestamp,reception_timestamp_submillis, string_value) VALUES
    ...
    """,
    """
      INSERT INTO #{@realm_test}.individual_properties (device_id, interface_id, endpoint_id, path, reception_timestamp,reception_timestamp_submillis, double_value) VALUES
    ...
    """
           INSERT INTO #{@realm_test}.individual_properties (device_id, interface_id, endpoint_id, path, reception_timestamp,reception_timestamp_submillis,double_value) VALUES
        (c8a03708-c774-ee45-9a0f-28fa68c3f80e, f7d5e358-c4e7-1ec7-521c-5f71cfb44667, a34e4310-7a71-7778-bf70-5aa9f8ca12bb, '/objectendpoint1', '2020-01-30 03:26:23.184+0000', 30,null);
    """
  ]

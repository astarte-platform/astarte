...
defmodule Astarte.Core.Generators.Triggers.SimpleEvents.PathCreatedEvent do
  @moduledoc """
  This module provides generators for Astarte Trigger Simple Event PathCreatedEvent struct.
  """

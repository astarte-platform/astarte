...
```sh
$ git clone https://github.com/astarte-platform/astarte.git -b v0.11-snapshot && cd astarte
...
```sh
$ git clone https://github.com/astarte-platform/astarte-device-sdk-qt5.git -b v0.11-snapshot
...
$ make install
$ cd -
$ git clone https://github.com/astarte-platform/stream-qt5-test.git -b v0.11-snapshot
$ cd stream-qt5-test
$ qmake .
$ make
```

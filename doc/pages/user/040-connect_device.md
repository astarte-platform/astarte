...
API](https://docs.astarte-platform.org/astarte/1.0/api/?urls.primaryName=Pairing%20API#/device),
...
API](https://docs.astarte-platform.org/astarte/1.0/api/#/device/updateDeviceStatus) or using

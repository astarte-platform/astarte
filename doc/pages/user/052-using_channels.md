...
format](https://github.com/astarte-platform/astarte_core/blob/release-0.11/lib/astarte_core/triggers/simple_events/encoder.ex).
...
files](https://github.com/astarte-platform/astarte_core/tree/release-0.11/lib/astarte_core/triggers/simple_events).
However, there are some discrepancies in mapping (e.g.). It is advised also to have a look at the
[encoder](https://github.com/astarte-platform/astarte_core/blob/release-0.11/lib/astarte_core/triggers/simple_events/encoder.ex).

...
Groups are currently useful mainly to provide access control, combining Astarte's [path based authorization](070-auth.html#authorization) with the fact that devices can be queried with a group
...
[AppEngine API](/api/index.html?urls.primaryName=AppEngine API). See the [Managing Groups page](065-managing-groups.html) in the User Guide for some usage examples.

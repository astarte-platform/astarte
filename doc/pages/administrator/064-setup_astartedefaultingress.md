...
Documentation](https://github.com/astarte-platform/astarte-kubernetes-operator/blob/v1.0.4/config/crd/bases/ingress.astarte-platform.org_astartedefaultingresses.yaml)
to learn more.

...
This [bash
script](https://github.com/astarte-platform/astarte-kubernetes-operator/blob/v1.0.0-rc.0/hack/upgrade-operator-011-10.sh)
...
```bash
ASTARTE_OP_UPGRADE_SCRIPT_URL=https://raw.githubusercontent.com/astarte-platform/astarte-kubernetes-operator/v1.0.0-rc.0/hack/upgrade-operator-011-10.sh

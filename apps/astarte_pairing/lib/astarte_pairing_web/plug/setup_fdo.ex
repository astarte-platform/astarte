...
defmodule Astarte.PairingWeb.Plug.SetupFDO do
  @moduledoc """
  Plug for setting up the connection for handling FDO messages, including parsing
  the message ID from the path, reading the CBOR body, and setting the appropriate response
  headers for the next message in the sequence. This plug is used in the FDO onboarding controller
  """

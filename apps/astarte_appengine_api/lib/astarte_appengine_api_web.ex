defmodule AstarteAppengineApiWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: AstarteAppengineApiWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View, root: "lib/astarte_appengine_api_web/templates",
                        namespace: AstarteAppengineApiWeb

      # Import convenience functions from controllers
      import Phoenix.Controller, only: [get_flash: 2, view_module: 1]

      import AstarteAppengineApiWeb.Router.Helpers
      import AstarteAppengineApiWeb.ErrorHelpers
      import AstarteAppengineApiWeb.Gettext
    end
  end

defmodule Astarte.AppEngine.APIWeb.InterfacePlug do
  ...
  def call(
    ...
    %{
      ...
      | method: new_method,
        ...
        request_path:
          "/v1/#{realm_name}/devices/#{device_id}/interfaces/#{interface}?#{new_query_string}"
    }
    |> Conn.assign(:original_path_info, original_path_info)
  end

  @doc """
  Rewrites any request to "/v1/:realm_name/devices-by-id/:device_alias/interfaces/:interface/PATH" to "/v1/:realm_name/devices/:device_alias/interfaces/:interface".
  Everything will be handled by phoenix router later.
  """
  def call(
        %Plug.Conn{
    ...
    ["v1", realm_name, "devices-by-alias", device_alias, "interfaces", interface | subpath] =
      conn.path_info
    ...
    %{
      ...
      | method: new_method,
        params: new_params,
        path_info: ["v1", realm_name, "devices-by-alias", device_alias, "interfaces", interface],
        query_params: new_query_params,
        query_string: new_query_string,
        request_path:
          "/v1/#{realm_name}/devices-by-alias/#{device_alias}/interfaces/#{interface}?#{
            new_query_string
          }"
    }
    |> Conn.assign(:original_path_info, original_path_info)
  ...
  @doc """
  Rewrites any request to "/v1/:realm_name/groups/:group_name/devices/:device_id/interfaces/:interface/PATH" to
  "/v1/:realm_name/groups/:group_name/devices/:device_id/interfaces/:interface".
  Everything will be handled by phoenix later.
  """
  def call(
        %Plug.Conn{
          path_info: [

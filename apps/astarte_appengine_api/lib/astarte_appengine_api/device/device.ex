...
defmodule Astarte.AppEngine.API.Device do
  ...
  @doc """
  Returns the list of interfaces_by_device_alias.

  ## Examples

      iex> list_interfaces_by_device_alias()
      [%InterfaceValuesByDeviceAlias{}, ...]

  """
  def list_interfaces_by_device_alias do
    raise "TODO"
  end

  @doc """
  Gets a single interface_values_by_device_alias.

  Raises if the Interface values by device alias does not exist.

  ## Examples

      iex> get_interface_values_by_device_alias!(123)
      %InterfaceValuesByDeviceAlias{}

  """
  def get_interface_values_by_device_alias!(id), do: raise "TODO"

  @doc """
  Creates a interface_values_by_device_alias.

  ## Examples

      iex> create_interface_values_by_device_alias(%{field: value})
      {:ok, %InterfaceValuesByDeviceAlias{}}

      iex> create_interface_values_by_device_alias(%{field: bad_value})
      {:error, ...}

  """
  def create_interface_values_by_device_alias(attrs \\ %{}) do
    raise "TODO"
  end

  @doc """
  Updates a interface_values_by_device_alias.

  ## Examples

      iex> update_interface_values_by_device_alias(interface_values_by_device_alias, %{field: new_value})
      {:ok, %InterfaceValuesByDeviceAlias{}}

      iex> update_interface_values_by_device_alias(interface_values_by_device_alias, %{field: bad_value})
      {:error, ...}

  """
  def update_interface_values_by_device_alias(%InterfaceValuesByDeviceAlias{} = interface_values_by_device_alias, attrs) do
    raise "TODO"
  end

  @doc """
  Deletes a InterfaceValuesByDeviceAlias.

  ## Examples

      iex> delete_interface_values_by_device_alias(interface_values_by_device_alias)
      {:ok, %InterfaceValuesByDeviceAlias{}}
  ...
  """
  def delete_interface_values_by_device_alias(%InterfaceValuesByDeviceAlias{} = interface_values_by_device_alias) do
    raise "TODO"
  end

  @doc """
  Returns a datastructure for tracking interface_values_by_device_alias changes.

  ## Examples

      iex> change_interface_values_by_device_alias(interface_values_by_device_alias)
      %Todo{...}

  """
  def change_interface_values_by_device_alias(%InterfaceValuesByDeviceAlias{} = interface_values_by_device_alias) do
    raise "TODO"
  end
end

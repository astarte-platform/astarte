...
defmodule Astarte.DataUpdaterPlantWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      counter("astarte.data_updater_plant.device_key_agreement.succeeded",
        tags: [:realm]
      ),
      counter("astarte.data_updater_plant.device_key_agreement.failed",
        tags: [:realm, :reason]
      ),
      counter("astarte.data_updater_plant.encrypted_message_handling_failure",
        tags: [:realm, :reason]
      )
    ]
  end

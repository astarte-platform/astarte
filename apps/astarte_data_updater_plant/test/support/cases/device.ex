...
defmodule Astarte.Cases.Device do
  ...
  setup_all %{realm_name: realm_name} do
    ...
    interface_descriptors = interface_descriptors(realm_name, interfaces_data.interfaces)
    endpoints = endpoints_by_interface_id(realm_name, interface_descriptors)

    interfaces = update_interfaces_id(interfaces_data.interfaces, interface_descriptors)
    interfaces = update_endpoints_ids(interfaces, endpoints)
  ...
  defp interface_descriptors(realm_name, interfaces) do
    for interface <- interfaces do
  ...
  defp endpoints_by_interface_id(realm_name, interface_descriptors) do

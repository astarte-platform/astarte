...
Mimic.copy(Astarte.DataUpdaterPlant.DataUpdater.Core.KeyAgreement.HandshakeState)
Mimic.copy(Astarte.DataUpdaterPlant.DataUpdater.Core.KeyAgreement.SharedSecret)
...
Mimic.copy(Astarte.DataUpdaterPlant.Health)
Mimic.copy(Astarte.DataUpdaterPlant.RPC.Server.Core)
Mimic.copy(Astarte.DataUpdaterPlant.RPC.VMQPlugin.ClientMock)

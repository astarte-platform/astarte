...
defmodule Astarte.DataUpdaterPlant.PayloadsDecoderTest do
  ...
  test "unset" do
    timestamp = decimillisecond_timestamp() |> Enum.at(0)
  ...
  defp decimillisecond_timestamp do
    gen all timestamp_seconds <- TimestampGenerator.timestamp(),
            decimilliseconds <- integer(0..9999) do
      timestamp_seconds * 10_000 + decimilliseconds
    end
  end

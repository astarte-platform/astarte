...
defmodule Astarte.DataUpdaterPlant.AMQPOptionsTest do
  ...
  describe "amqp producer options" do
    test "get default values when not set" do
      ...
      assert channels: 1 in amqp_producer_options

      assert Config.amqp_producer_options!() |> Keyword.delete(:channels) ==
               Config.amqp_consumer_options!() |> Keyword.delete(:channels)
    end

...
defmodule Astarte.RealmManagementWeb.VersionController do
  ...
  operation :show,
    ...
    description:
      "Return the Realm Management API version. This endpoint is available at {base_url}/version (without /v1).",
  ...
  operation :show_with_realm,
    summary: "Retrieve API version",
    description: "Return the Realm Management API version.",

...
defmodule Astarte.RealmManagementWeb.FallbackController do
  @moduledoc """
  ...
  def call(conn, {:error, %Ecto.Changeset{} = changeset}) do
    ...
    |> put_view(Astarte.RealmManagementWeb.ChangesetView)
  ...
  def call(conn, {:error, :interface_major_version_does_not_exist}) do
    conn
    |> put_status(:not_found)
    |> put_view(Astarte.RealmManagementWeb.InterfaceView)

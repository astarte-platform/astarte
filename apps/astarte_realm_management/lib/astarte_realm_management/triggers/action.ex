...
defmodule Astarte.RealmManagement.Triggers.Action do
  @moduledoc """
  This module provides a wrapper for data held
  either in an Astarte.RealmManagement.Triggers.AMQPAction
  or in an Astarte.RealmManagement.Triggers.HttpAction struct.

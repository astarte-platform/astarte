...
defmodule Astarte.RealmManagement.API.CreateDatastreamIndividualMultiInterface do
  use Ecto.Migration
  ...
  def up do
    create_if_not_exists table("individual_datastreams", primary_key: false) do
      ...
      add :value_timestamp, :timestamp, cluster_key: true
      add :reception_timestamp, :timestamp, cluster_key: true
      add :reception_timestamp_submillis, :smallint, cluster_key: true

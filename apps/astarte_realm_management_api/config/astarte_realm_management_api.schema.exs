...
[
  ...
  mappings: [
    ...
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.url.host": [
      ...
      default: "localhost",
      doc:
        "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.url.host here.",
      hidden: true,
    ...
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.secret_key_base":
      [
        ...
        doc:
          "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.secret_key_base here.",
        hidden: true,
        to:
          "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.secret_key_base"
      ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.view":
      [
        ...
        doc:
          "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.view here.",
        hidden: true,
        to:
          "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.view"
      ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.accepts":
      [
        ...
        doc:
          "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.accepts here.",
        hidden: true,
        to:
          "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.render_errors.accepts"
      ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.name": [
      ...
      doc:
        "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.name here.",
      hidden: true,
      to:
        "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.name"
    ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.adapter":
      [
        ...
        doc:
          "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.adapter here.",
        hidden: true,
        to:
          "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.pubsub.adapter"
      ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.debug_errors": [
      ...
      default: true,
      doc:
        "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.debug_errors here.",
      hidden: true,
      to:
        "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.debug_errors"
    ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.code_reloader": [
      ...
      default: true,
      doc:
        "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.code_reloader here.",
      hidden: true,
      to:
        "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.code_reloader"
    ],
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.check_origin": [
      ...
      default: false,
      doc:
        "Provide documentation for astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.check_origin here.",
      hidden: true,
      to:
        "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.check_origin"
    ],
  ...
  transforms: [
    "astarte_realm_management_api.Elixir.Astarte.RealmManagement.APIWeb.Endpoint.http.ip":
      fn conf ->
        [{_, ip}] =
          Conform.Conf.get(
            conf,

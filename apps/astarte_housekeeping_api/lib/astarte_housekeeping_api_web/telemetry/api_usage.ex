...
defmodule Astarte.Housekeeping.APIWeb.Telemetry.APIUsage do
  alias Astarte.Housekeeping.APIWeb.TelemetryTaskSupervisor
    ...
    Task.Supervisor.start_child(TelemetryTaskSupervisor, fn ->
      case String.split(path, "/", trim: true) do
        [@api_prefix, _] ->
          ...
          :telemetry.execute([:astarte, :housekeeping, :api, :request], measurements)

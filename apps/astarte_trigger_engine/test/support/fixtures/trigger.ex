...
defmodule Astarte.Fixtures.Trigger do
  ...
  def default_action_triggers do
    action = """
    {
    ...
    [
      %Trigger{
        ...
        name: "default_action_trigger_1",
        action: action
      }
    ]
  end

  def mustache_triggers do
    action_1 = """
    {
    ...
    [
      %Trigger{
        ...
        name: "trigger_mustache_1",
        action: action_1
      },
      %Trigger{
        trigger_uuid: <<253, 52, 226, 246, 41, 25, 73, 20, 175, 162, 25, 77, 242, 196, 195, 249>>,
        name: "trigger_mustache_2",
        action: action_2
      }
    ]
  end

  def triggers_with_static_headers do
    action = """
    {
      "http_url": "http://hello.world.ai",
      "http_method": "put",
    ...
    [
      %Trigger{
        ...
        name: "trigger_with_static_headers_1",
        action: action
      }
    ]
  end

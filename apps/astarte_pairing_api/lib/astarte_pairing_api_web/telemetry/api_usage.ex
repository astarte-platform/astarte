...
defmodule Astarte.Pairing.APIWeb.Telemetry.APIUsage do
  alias Astarte.Pairing.APIWeb.TelemetryTaskSupervisor
    ...
    Task.Supervisor.start_child(TelemetryTaskSupervisor, fn ->
      case String.split(path, "/", trim: true) do
        [@api_prefix, realm | _] ->
          ...
          :telemetry.execute([:astarte, :pairing, :api, :request], measurements, metadata)

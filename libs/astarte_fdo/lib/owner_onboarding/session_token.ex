...
defmodule Astarte.FDO.OwnerOnboarding.SessionToken do
  @moduledoc """
  ...
  def generate(guid, nonce) do
    ...
    Token.sign(Config.fdo_session_secret_key_base!(), @token_salt, claims)
  end
  ...
  """
  def verify(token) do
    case Token.verify(Config.fdo_session_secret_key_base!(), @token_salt, token,
           max_age: @max_age
         ) do

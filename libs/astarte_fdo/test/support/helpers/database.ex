...
defmodule Astarte.FDO.Helpers.Database do
  @moduledoc false
  import Ecto.Query

  alias Astarte.Core.Device
  alias Astarte.DataAccess.Consistency
  alias Astarte.DataAccess.Device, as: QueryDevice
  ...
  @registered_not_confirmed_credentials_secret :crypto.strong_rand_bytes(32)
                                               |> Base.encode64()

  @registered_and_confirmed_256_credentials_secret :crypto.strong_rand_bytes(32)
                                                   |> Base.encode64()
  ...
  def get_first_registration(realm, hardware_id) do
    ...
    {:ok, device} = QueryDevice.fetch(realm, device_id)

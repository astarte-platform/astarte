...
defmodule Astarte.FDO.Rendezvous do
  @moduledoc """
  Handles the FDO Rendezvous protocol, including sending the Hello message
  and completing the device-to-rendezvous-server handshake.
  """

  alias Astarte.FDO.Cbor.Core, as: CBORCore
  alias Astarte.FDO.Rendezvous.Client
  alias Astarte.FDO.Rendezvous.Core

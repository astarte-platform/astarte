...
defmodule Astarte.FDO.Core.OwnerOnboarding.Core do
  @moduledoc """
  Implements the FDO Key Derivation Function (KDF) in Counter Mode as defined
  in [SP800-108], section 5.1, used during the TO2 Owner Onboarding protocol.
  """

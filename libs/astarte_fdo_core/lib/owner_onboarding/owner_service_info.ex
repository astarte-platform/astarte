...
defmodule Astarte.FDO.Core.OwnerOnboarding.OwnerServiceInfo do
  @moduledoc """
  ...
  typedstruct enforce: true do
    ...
    # - If true: The Device must acknowledge with an empty DeviceServiceInfo, allowing the Owner
    #   to continue.
    ...
    # - If true: The ServiceInfo phase ends. The Device will proceed to process data and

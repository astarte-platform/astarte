...
defmodule Astarte.FDO.Core.Config do
  ...
  @envdoc "Secret key base used to sign FDO session tokens"
  app_env(:fdo_session_secret_key_base, :astarte_pairing, :fdo_session_secret_key_base,
    os_env: "FDO_SESSION_SECRET_KEY_BASE",
    type: :binary
  )

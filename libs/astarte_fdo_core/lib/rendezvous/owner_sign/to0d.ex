...
defmodule Astarte.FDO.Core.Rendezvous.OwnerSign.TO0D do
  @moduledoc """
  This module defines the structure and encoding functions for
  the TO0D object in the FDO protocol.
  """

...
defmodule Astarte.FDO.Core.OwnershipVoucher.CreateRequest do
  ...
  typed_embedded_schema do
    ...
    field(:decoded_ownership_voucher, :any, virtual: true) :: OwnershipVoucher.decoded_voucher()
    field :device_guid, :binary
  end

  def changeset(%CreateRequest{} = request, params) do
    request
  ...
  defp put_device_guid(changeset) do
    ...
    with {:ok, binary_voucher} <- OwnershipVoucher.binary_voucher(ownership_voucher),

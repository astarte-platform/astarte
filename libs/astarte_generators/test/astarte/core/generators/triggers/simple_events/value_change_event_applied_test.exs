...
defmodule Astarte.Core.Generators.Triggers.SimpleEvents.ValueChangeAppliedEventTest do
  ...
  @moduletag :value_change_applied_event

  @doc false
  describe "triggers value_change_applied_event generator" do
    @describetag :success
    @describetag :ut

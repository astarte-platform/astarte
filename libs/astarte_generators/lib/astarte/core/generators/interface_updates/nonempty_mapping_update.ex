...
defmodule Astarte.Core.Generators.InterfaceUpdates.NonemptyMappingUpdate do
  @moduledoc """
  Generates nonempty Astarte interface updates.
  """
  ...
  """
  @spec valid_nonempty_mapping_update_for(
          Interface.t(),
  ...
  def valid_nonempty_mapping_update_for(interface, representation, params \\ []),
    do:
      valid_mapping_update_for(
        interface,
        representation,
        Keyword.put(params, :selection, :nonempty)
      )
end

...
defmodule Astarte.Core.Generators.InterfaceUpdates.FallibleMappingUpdate do
  @moduledoc """
  Generates fallible Astarte interface updates.
  """
  ...
  """
  @spec valid_fallible_mapping_update_for(
          Interface.t(),
  ...
  def valid_fallible_mapping_update_for(interface, representation, params \\ []),
    do:
      valid_mapping_update_for(
        interface,
        representation,
        Keyword.put(params, :selection, :fallible)
      )
end

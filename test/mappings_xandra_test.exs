...
defmodule Astarte.DataAccess.Mappings.XandraTest do
  ...
  alias Astarte.DataAccess.Mappings.Xandra, as: XandraMappings
  ...
  setup_all do
    ...
    Supervisor.start_link([{Xandra.Cluster, xandra_options}],
      ...
      name: Astarte.DataAccess.Mappings.XandraTest.Supervisor
    )
  ...
  test "fetch interface mappings" do
    Xandra.Cluster.run(:xandra, fn conn ->
      assert XandraMappings.fetch_interface_mappings_map(
               conn,
               @test_realm,
      ...
      assert XandraMappings.fetch_interface_mappings_map(conn, @test_realm, @test_interface_id,
               include_docs: true
             ) ==
               {:ok, @test_mapping}
    end)

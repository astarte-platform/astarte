...
![](https://github.com/astarte-platform/astarte/workflows/Build%20and%20Test%20Astarte%20Apps/badge.svg?branch=v1.3.0)
[![codecov](https://codecov.io/gh/astarte-platform/astarte/tag/v1.3.0/graph/badge.svg)](https://codecov.io/gh/astarte-platform/astarte)
...
```sh
$ git clone https://github.com/astarte-platform/astarte.git -b v1.3.0 && cd astarte
$ docker run -v $(pwd)/compose:/compose astarte/docker-compose-initializer:1.3.0
$ docker compose pull
$ docker compose up -d
```

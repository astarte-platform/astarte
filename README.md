...
![](https://github.com/astarte-platform/astarte/workflows/Build%20and%20Test%20Astarte%20Apps/badge.svg?branch=v1.2.2)
[![codecov](https://codecov.io/gh/astarte-platform/astarte/tag/v1.2.2/graph/badge.svg)](https://codecov.io/gh/astarte-platform/astarte)
...
```sh
$ git clone https://github.com/astarte-platform/astarte.git -b v1.2.2 && cd astarte
$ docker run -v $(pwd)/compose:/compose astarte/docker-compose-initializer:1.2.2
$ docker compose pull
$ docker compose up -d
```
